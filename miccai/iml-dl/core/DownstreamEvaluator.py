...
class DownstreamEvaluator(object):
    """
    Downstream Tasks
        - run tasks at training_end, e.g. anomaly detection, reconstruction
        fidelity, disease classification, etc..
    """

    def __init__(self, name, model, hyper_setup, device, test_data_dict,
                 checkpoint_path):
        """
    ...
    def start_task(self, global_model):
        """
        Function to perform analysis after training is complete, e.g., call
        downstream tasks routines, e.g.
        ...
        """
        raise NotImplementedError("[DownstreamEvaluator::start_task]: "
                                  "Please Implement start_task() method")
